  ...
  return (
    <Layout>
      <section className="container mx-auto">
        <div>
          <h1 className="capitalize text-2xl md:text-5xl">
            contact information
          </h1>
        </div>
        ...
        <div className="">
          ...
          <div className="my-8 flex flex-col gap-y-2">
            <span className="flex gap-x-5 items-center">
              ...
              <h4 className="text-xl first-letter:capitalize">
                i'm interested in furniture and unique styles
              </h4>
            </span>

            <span className="flex gap-x-5 items-center">
              <input type="checkbox" className="" />
              <h4 className="text-2xl capitalize underline">
                get Woodsoft updates
              </h4>
            </span>
          </div>
          ...
          <div>
            <p className="max-w-[700px]">
              ...
              information with Woodsoft to be contacted with more details or
              offers about Woodsoft products.
            </p>
          </div>
